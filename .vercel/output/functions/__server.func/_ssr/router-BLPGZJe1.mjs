...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BLPGZJe1.js
...
var styles_default = "/assets/styles-BBb8Twxr.css";
var APP_NAME = "Amal & Aparna";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Aparna and Amal T S — wedding album. 25 January 2027 at MK Convention Centre, Eramalloor."
			},
			{
				name: "theme-color",
				content: "#6E2430"
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AuthProvider, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Outlet, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
					position: "top-center",
					toastOptions: { className: "font-sans !bg-cream !text-ink !border-gold/30 !shadow-soft" }
				})] }),
...
var getAlbum = createServerFn({ method: "GET" }).handler(createSsrRpc("500977f2fa417762a313cb9fa917e6586c72649a71268acb2bb9452a2dcdd90b"));
var verifyEditor = createServerFn({ method: "POST" }).validator(object({
	username: string().min(1).max(80),
	password: string().min(1).max(80)
})).handler(createSsrRpc("ea8a853a6fffea86627b59862d9d8ae82256b5ecf1e4e23182979c33b8ccd891"));
var saveAlbum = createServerFn({ method: "POST" }).validator(object({
	username: string().min(1).max(80),
	password: string().min(1).max(80),
	album: albumSchema
})).handler(createSsrRpc("97749df6057b2012678c0875e3e9ea547ee7172b26762f6bf2f544d34f9fdddd"));
var $$splitComponentImporter = () => import("./routes-Dry9PH-0.mjs");
...
//#endregion
export { verifyEditor as i, Route as n, saveAlbum as r, router_exports as t };
