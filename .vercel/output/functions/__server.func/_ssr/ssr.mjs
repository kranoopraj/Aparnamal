...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-cGH-wjGl.mjs");
...
var manifest = {
	"500977f2fa417762a313cb9fa917e6586c72649a71268acb2bb9452a2dcdd90b": {
		functionName: "getAlbum_createServerFn_handler",
		importer: () => import("./album-api-Dlq8wVq6.mjs")
	},
	"97749df6057b2012678c0875e3e9ea547ee7172b26762f6bf2f544d34f9fdddd": {
		functionName: "saveAlbum_createServerFn_handler",
		importer: () => import("./album-api-Dlq8wVq6.mjs")
	},
	"ea8a853a6fffea86627b59862d9d8ae82256b5ecf1e4e23182979c33b8ccd891": {
		functionName: "verifyEditor_createServerFn_handler",
		importer: () => import("./album-api-Dlq8wVq6.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BLPGZJe1.mjs").then((n) => n.t),
